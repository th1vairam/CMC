...
qsub -v dataFile="../CMC/data.csv",pathv="/shared/metanetworkSynapse/ARACNE/",aracne=1,aracneFull=1,correlation=1,correlationBonferroni=1,correlationFDR=1,wgcna=1,numberCore=1 -pe orte 8 buildNet.sh
#./pushNet.sh -a "syn4229809" -b "../CMC/code.txt" -c "../CMC/syn.txt" -defghijklmnopqv -r "none" -s "HomoZapiens" -t "bonitis" -u "blood"